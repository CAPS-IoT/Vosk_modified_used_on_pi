...
void ProcessWindow(const FrameExtractionOptions &opts,
  ...
  // std::cout << "dc offset: "<< window->Sum() / frame_length << std::endl;
...
void ExtractWindow(int64 sample_offset,
  ...
  // std::cout << "samp_freq: " << opts.samp_freq << std::endl;
  // std::cout << "frame_shift_ms: " << opts.frame_shift_ms << std::endl;
  // std::cout << "frame_length_ms: " << opts.frame_length_ms << std::endl;
  // std::cout << "dither: " << opts.dither << std::endl;
  // std::cout << "preemph_coeff: " << opts.preemph_coeff << std::endl;
  // std::cout << "remove_dc_offset: " << (opts.remove_dc_offset ? "true" : "false") << std::endl;
  // std::cout << "window_type: " << opts.window_type << std::endl;
  // std::cout << "round_to_power_of_two: " << (opts.round_to_power_of_two ? "true" : "false") << std::endl;
  // std::cout << "blackman_coeff: " << opts.blackman_coeff << std::endl;
  // std::cout << "snip_edges: " << (opts.snip_edges ? "true" : "false") << std::endl;
  // std::cout << "allow_downsample: " << (opts.allow_downsample ? "true" : "false") << std::endl;
  // std::cout << "allow_upsample: " << (opts.allow_upsample ? "true" : "false") << std::endl;
  // std::cout << "max_feature_vectors: " << opts.max_feature_vectors << std::endl;
  int32 frame_length = opts.WindowSize(),
